...
*/
function dinosaur(name,diet,weigh,length,period){
  return{
     name,
     diet,
     weigh,
...
zooAnimals.forEach(function(item){
 displayNames.push([item.scientific_name,item.animal_name])
});
...
let anotherPush=zooAnimals.filter(function(item){
 return item.population<5;
})
lowPopulationAnimals.push(anotherPush);
console.log(lowPopulationAnimals);

/* Request 4: .reduce() <----------------------------------------UNFINISHED
